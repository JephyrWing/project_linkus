...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests((auth) ->
                auth.requestMatchers("/", "/api/users/login", "/api/users/oauth/kakao", "/api/users/signup", "/api/users/signup/idconfirm/*", "/api/users/signup/emailconfirm/*", "/api/chats", "/api/chats/*", "/error").permitAll()
